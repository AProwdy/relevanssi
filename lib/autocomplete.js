( function () {
	...
	function setupField( input ) {
		...
		spinner.className = 'relevanssi-autocomplete-spinner';
		...
		function showLoading() {
			wrapper.classList.add( 'relevanssi-autocomplete-loading' );
		}

		function hideLoading() {
			wrapper.classList.remove( 'relevanssi-autocomplete-loading' );
		}
